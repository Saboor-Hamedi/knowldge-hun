...
export const codicons = {
  ...
  folderConfig: '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M14.5 3H7.71l-.85-.85L6.51 2h-5l-.5.5v11l.5.5h13l.5-.5v-10L14.5 3zm-.51 8h-12V6h12v5zM8 7h1v3H8z"/></svg>',
  folderTest: '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M14.5 3H7.71l-.85-.85L6.51 2h-5l-.5.5v11l.5.5h13l.5-.5v-10L14.5 3zm-.51 8h-12V6h12v5zM9 8l2 2 2-2"/></svg>',
  ...
  // Activity bar
  files: '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M14.5 1H7l-.85.85-.65-.65L5 .7l-.5.5-.65.65L3.35 1H1.5l-.5.5v13l.5.5h13l.5-.5v-13l-.5-.5zm-.51 13H2V2h1.49l.5-.5.71.71L5.5 1.7l.71.71.71-.71.5.5H14v11z"/><path d="M12 6H4V5h8v1zm0 2H4V7h8v1zm-4 2H4V9h4v1z"/></svg>',
  search: '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M11.5 7a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0zm-.82 4.74a6 6 0 1 1 1.06-1.06l3.04 3.04-.71.71-3.39-3.69z"/></svg>',
  ...
  palette: '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M15.46 3.03l-3-2.6A1.85 1.85 0 0 0 10 .93h-.06l-3.37 1a3.07 3.07 0 0 0-1.61 1.25l-2.6 4.31a.52.52 0 0 0 .15.68l4.47 3a.52.52 0 0 0 .62-.11l2.84-3.34A2.94 2.94 0 0 0 11 5.92l.89-3.23.09.07 1.83 1.58.55-.26A1.5 1.5 0 0 0 16 2.68a1.53 1.53 0 0 0-.54.35zM4 14.5a3 3 0 1 1 4.24-4.24L4 14.5zM3.29 13.8L6.82 10.27 3.29 13.8zM8.33 6.64l-2.9 3.41-3.6-2.41 2.6-4.32a2.12 2.12 0 0 1 1-.84l2.9-.84z"/></svg>',
