...
export class NotificationManager {
  ...
  private getIcon(type: NotificationType, title?: string, message?: string): string {
    ...
    if (title === 'Update') {
      return codicons.cloudDownload || '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M13 7l-4.5 4.5L4 7h3V2h3v5h3zm-8 6h10v1H5v-1z" fill-rule="evenodd" clip-rule="evenodd"/></svg>'
    }
    switch (type) {
